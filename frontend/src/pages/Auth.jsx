...
export function Auth({ mode = 'login', onToggleMode, onLogin, onRegister, loading, error }) {
  ...
  return (
    <main className="flex-grow flex items-center justify-center p-4 sm:p-6 lg:p-12">
      <div className="w-full max-w-5xl bg-white dark:bg-card-dark rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden grid grid-cols-1 lg:grid-cols-2">
        {/* Left side - Form */}
